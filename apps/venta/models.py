...
class Venta(models.Model):
    ...
    hora_inicio = models.DecimalField(default=0.00, max_digits=9, decimal_places=2)
    hora_fin = models.DecimalField(default=0.00, max_digits=9, decimal_places=2)
    ...
    def toJSON(self):
        ...
        item['hora_inicio'] = format(self.hora_inicio, '.2f')
        item['hora_fin'] = format(self.hora_fin, '.2f')
